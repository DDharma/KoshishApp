...
class Addmember : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        admin = if (findViewById<RadioButton>(R.id.admin).isChecked){
            1
        } else{
            0
        }
        ...
        sunday = if (findViewById<RadioButton>(R.id.sunday).isChecked){
            1
        }else{
            0
        }

        monday = if (findViewById<RadioButton>(R.id.monday).isChecked){
            1
        }else{
            0
        }

        tuesday = if (findViewById<RadioButton>(R.id.tuesday).isChecked){
            1
        }else{
            0
        }

        wednesday = if (findViewById<RadioButton>(R.id.wednesday).isChecked){
            1
        }else{
            0
        }

        thursday = if (findViewById<RadioButton>(R.id.thursday).isChecked){
            1
        }else{
            0
        }

        friday = if (findViewById<RadioButton>(R.id.friday).isChecked){
            1
        }else{
            0
        }

        saturday = if (findViewById<RadioButton>(R.id.saturday).isChecked){
            1
        }else{
            0
        }
